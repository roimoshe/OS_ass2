...
struct proc {
  ...
  uint signals_mask;                    // 
  struct sigaction signal_handlers[32]; // An array of user signal handlers
  struct trapframe *tf_backup;          // Trap frame backup for current syscall
  volatile int stopped;                 // If non-zero, have been stopped
